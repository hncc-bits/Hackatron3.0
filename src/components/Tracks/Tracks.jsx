...
const Tracks = () => {
    ...
    const trackData = [
        ...
        */
        ...
        { id: 7, title: 'Real Time Disaster Resource Coordination Platform', description: 'Design a real-time disaster response platform connecting affected individuals, volunteers, and NGOs. It enables help requests, live location sharing, resource coordination, and request tracking with volunteer allocation and real-time communication. Optimized for low-connectivity environments, it reduces coordination gaps, avoids duplication, and ensures faster, more efficient disaster relief.', image: education, card: education_card, pdf: '/tracks/DisasterManagement_Hackatron3.0_Track.pdf' },
